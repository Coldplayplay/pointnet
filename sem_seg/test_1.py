...
#from pointnet.sem_seg import indoor3d_util
...
parser.add_argument('--output_filelist', default='81test/output_filelist.txt',
                    help='TXT filename, filelist, each line is an output for a room')
parser.add_argument('--room_data_filelist', default='meta/81_data_paths.txt',
